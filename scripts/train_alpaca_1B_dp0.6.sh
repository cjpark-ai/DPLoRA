...
max_seq_length=512
warmup_ratio=0.059
pruning_target_reduction=0.6
pruning_steps=10
importance_ema_decay=0.274
momentum_penalty_weight=0.084
stable_layer_bonus=0.151
...
for SEED in "${SEEDS[@]}"; do
    ...
    OUTPUT_DIR="${PROJECT_DIR}/output/${TASK_NAME}_1B_dp${pruning_target_reduction}_seed${SEED}_${EXPERIMENT_TIMESTAMP}"
    ...
    python3 -m training.train_alpaca \
        ...
        --stable_layer_bonus $stable_layer_bonus 2>&1 | tee "$OUTPUT_DIR/full_terminal_output.log"
