...
pruning_steps=10
importance_ema_decay=0.147
momentum_penalty_weight=0.296
stable_layer_bonus=0.07
...
for SEED in "${SEEDS[@]}"; do
    ...
    OUTPUT_DIR="${PROJECT_DIR}/output/${TASK_NAME}_8B_dp${pruning_target_reduction}_seed${SEED}_${EXPERIMENT_TIMESTAMP}"
