...
LORA_BUDGET=11850000  # Same budget as trial_5 (40M parameters)
...
pruning_steps=10
importance_ema_decay=0.056
momentum_penalty_weight=0.605
stable_layer_bonus=0.025
...
for SEED in "${SEEDS[@]}"; do
    ...
    OUTPUT_DIR="${PROJECT_DIR}/output/${TASK_NAME}_3B_dp${pruning_target_reduction}_seed${SEED}_${EXPERIMENT_TIMESTAMP}"
