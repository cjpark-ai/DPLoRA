...
max_seq_length=128
warmup_ratio=0.054
pruning_target_reduction=0.5
pruning_steps=10
importance_ema_decay=0.202
momentum_penalty_weight=0.054
stable_layer_bonus=0.056

RECOVERY_STEPS=500  # Recovery steps after pruning
EXTENDED_RECOVERY_STEPS=1000
